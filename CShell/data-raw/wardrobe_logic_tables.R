...
wardrobe_logic <- list(
  ...
  "Undergarments" = list(
    ...
    "Breathable Undergarments" = function(w) w$temp > 75 || w$humidity > 70,
    "Standard Cotton Undergarments"      = function(w) TRUE
  ),
  "Bottoms" = list(
...
# SAVE AS INTERNAL
usethis::use_data(wardrobe_logic, internal = TRUE, overwrite = TRUE)
